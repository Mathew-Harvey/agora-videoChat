...
let joinRoomInit = async() => {
    ...
    await rtmClient.login({uid, token}) // agora authentication is currently set to app only so this works for now
    ...
    getMembers()
    addBotMessageToDom(`Welcome to your Diana chat room ${displayName}! 👋`)
